...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="content-wrapper py3">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12 mt20">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><i class="fa fa-edit"></i> 添加</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="" class="form-horizontal" id="admin_add">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label">用户名：</label>
                            <div class="col-sm-5"><input type="text" name="username" id="username" placeholder="请填写用户名" class="form-control"></div>
                        </div>
                        <div class="form-group">
                            <label for="password" class="col-sm-2 control-label">密码：</label>
                            <div class="col-sm-5"><input type="password" name="password" id="password" placeholder="请填写密码" class="form-control"></div>
                        </div>
                        <div class="form-group">
                            <label for="realname" class="col-sm-2 control-label">真实姓名：</label>
                            <div class="col-sm-5"><input type="text" name="realname" id="realname" placeholder="请填写真实姓名" class="form-control"></div>
                        </div>
                        <div class="form-group">
                            <label for="email" class="col-sm-2 control-label">个人邮箱：</label>
                            <div class="col-sm-5"><input type="text" name="email" id="email" placeholder="请填写email" class="form-control"></div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button class="btn btn-primary" type="button" id="admin_add_sub">提交</button>
                            </div>
                        </div>
                    </form>
                </div>
