        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12 mt20">
                    <ol class="breadcrumb">
                        <li><i class="fa fa-dashboard"></i><a href="/admin.php?c=admin"> 用户管理</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="btn-group">
                        <button class="btn btn-primary" type="button" id="button-add" ><i class="fa fa-plus fa-lg"></i>添加</button>
                    </div>
                </div> 
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="table-responsive">
                        <from id="">
                            <table class="table table-bordered table-hover admin_list">
                                <thead>
                                    <tr>
                                        <!-- <th width="14">排序</th> -->
                                        <th>id</th>
                                ...
                                <tbody>
                                    <?php if(is_array($adminUsers)): $i = 0; $__LIST__ = $adminUsers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$adminUser): $mod = ($i % 2 );++$i;?><tr>
                                            <!-- <td><input size="4" type="text" name="" value=""></td> -->
                                            <td><?php echo ($adminUser["admin_id"]); ?></td>
                                            <td><?php echo ($adminUser["username"]); ?></td>
                                            <td><?php echo ($adminUser["realname"]); ?></td>
                                            <td><?php echo (date('Y-m-d H:i', $adminUser["lastlogintime"])); ?></td>
                                            <td>
                                                <section class="pull-left" id="txt_status">
                                                    <?php echo (getStatus($adminUser["status"])); ?>
                                                </section>
                                                <span class="pull-left" style="margin: 0 5px">|</span>
                                                <section class="pull-left">
                                                    <div class="turn">
                                                        <label for="checkbox"></label>
                                                        <input type="checkbox" id="checkbox" attr-id="<?php echo ($adminUser["admin_id"]); ?>" attr-message="状态" <?php if($adminUser["status"] == 1): ?>checked<?php endif; ?>>
                                                        <span></span>
                                                    </div>
                                                </section>
                                            </td>
                                            <td>
                                                <i class="fa fa-lg fa-edit fa-cursor" id="admin_edit" attr-id="<?php echo ($adminUser["admin_id"]); ?>"></i>
                                                <i class="fa fa-lg fa-trash-o fa-cursor" id="admin_del" attr-id="<?php echo ($adminUser["admin_id"]); ?>" attr-a="admin" attr-message="删除"></i>
                                            </td>
                        ...
                        <div class="btn-group">
                            <!--<button class="btn btn-primary"><i class="fa fa-lg fa-sort-amount-asc"></i>更新排序</button>-->
                        </div>
                    </div>
                </div>
            </div>
