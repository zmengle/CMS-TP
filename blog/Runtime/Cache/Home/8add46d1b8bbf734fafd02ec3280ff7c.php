            ...
            <div class="col-md-9">
                <div class="recommend clearfix">
                    <div class="banner">
                        ...
                        <span class="do-count"><i>阅读数</i>1</span>-->
                        <?php if(is_array($banner_news)): $i = 0; $__LIST__ = array_slice($banner_news,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$banner_new): $mod = ($i % 2 );++$i;?><a href="<?php echo (getNewUrl($banner_new["news_id"])); ?>" class="radius-shadow"><img src="<?php echo ($banner_new["thumb"]); ?>" alt="<?php echo ($banner_new["title"]); ?>"></a>
                            <span class="do-count"><i>阅读数</i><s class="news-count node-<?php echo ($banner_new["news_id"]); ?>" attr-id="<?php echo ($banner_new["news_id"]); ?>" id="node-<?php echo ($banner_new["news_id"]); ?>"></s></span><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                    <div class="small_banner">
                        <!-- small_banner -->
                        <!--<a href="#" class="radius-shadow"><span><i class="">26</i>2017年7月</span><img src="Public/images/banner1.jpg" alt=""></a>-->
                        <!--<a href="#" class="radius-shadow"><span><i class="">26</i>2017年7月</span><img src="Public/images/banner1.jpg" alt=""></a>-->
                        <!--<a href="#" class="radius-shadow"><span><i class="">26</i>2017年7月</span><img src="Public/images/banner1.jpg" alt=""></a>-->
                        <?php if(is_array($small_banner_news)): $i = 0; $__LIST__ = array_slice($small_banner_news,0,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s_b_new): $mod = ($i % 2 );++$i;?><a href="<?php echo ($s_b_new["url"]); ?>" class="radius-shadow"><span><i class=""><?php echo (date('d', $s_b_new["create_time"])); ?></i><?php echo (date('Y m', $s_b_new["create_time"])); ?></span><img src="<?php echo ($s_b_new["thumb"]); ?>" alt="<?php echo ($s_b_new["title"]); ?>"></a><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
                <div class="page-list" style="margin-top: 20px;">
                    <?php if(is_array($page_list)): $i = 0; $__LIST__ = array_slice($page_list,0,4,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><div class="row content clearfix ">
                            <?php if($new['thumb'] != null): ?><div class="hidden-xs col-sm-3">
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    ...
                                    <div class="remark">
                                        ...
                                        <span><i class="fa fa-star"></i> 阅读(<s class="news-count node-<?php echo ($new["news_id"]); ?>" attr-id="<?php echo ($new["news_id"]); ?>" id="node-<?php echo ($new["news_id"]); ?>"></s>)</span>
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="col-xs-12">
                    ...
                    <!--<div class="row content clearfix ">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <dl>
                               <dt><a href="">这是标题</a></dt>
                               <dd>这是内容简介当你重置浏览器大小的过程中，页面也会根据浏览器的宽度和高度重新渲染页面...</dd>
                           </dl>
                           <div class="remark">
...
<footer>
    ...
    <script>
        var SCOPE={
            'getCount_url':'/index.php?c=index&a=getCount'
        };
    </script>
